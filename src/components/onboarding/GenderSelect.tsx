...
export const GenderSelect: React.FC<GenderSelectProps> = ({ value, onChange, onNext }) => {
  return (
    ...
    >
      <h2 className="text-xl sm:text-2xl font-bold text-primary-700 mb-4 sm:mb-6">Please select your gender</h2>
      <div className="grid grid-cols-2 gap-3 sm:gap-6 max-w-2xl mx-auto">
        ...
        >
          ...
          <span className="text-base sm:text-xl text-primary-700">👨 Male</span>
        </button>
        <button
          onClick={() => {
            onChange('female');
        ...
        >
          ...
          <span className="text-base sm:text-xl text-primary-700">👩 Female</span>
        </button>
      </div>
    </motion.div>
  );
